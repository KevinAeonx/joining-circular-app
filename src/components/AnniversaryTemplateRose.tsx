...
const PETALS = [
  {x:22,y:88,rx:6,ry:11,a:20},{x:30,y:110,rx:5,ry:10,a:-30},{x:18,y:132,rx:6,ry:11,a:15},
  {x:578,y:88,rx:6,ry:11,a:-20},{x:570,y:110,rx:5,ry:10,a:30},{x:582,y:132,rx:6,ry:11,a:-15},
  {x:22,y:580,rx:6,ry:11,a:20},{x:30,y:602,rx:5,ry:10,a:-30},{x:578,y:580,rx:6,ry:11,a:-20},{x:570,y:602,rx:5,ry:10,a:30},
];

export default function AnniversaryTemplateRose({ formData, message, id }: Props) {
  ...
  return (
    <div id={id} style={{
      ...
      <div style={{ position:"absolute", top:"18px", left:0, right:0, display:"flex", justifyContent:"center", zIndex:4 }}>
        <div style={{ backgroundColor:"rgba(255,255,255,0.75)", borderRadius:"14px", padding:"6px 22px", border:"1px solid rgba(240,98,146,0.25)" }}>
      ...
      <div style={{
        ...
        {message || <span style={{ color:"rgba(136,14,79,0.40)", fontStyle:"italic" }}>Fill in details and generate a message...</span>}
      </div>
      ...
      <div style={{ position:"absolute", bottom:"24px", left:0, right:0, textAlign:"center", zIndex:4 }}>
        ...
        <div style={{ color:"#880E4F", fontSize:"16px", fontWeight:"bold", marginTop:"3px" }}>The AeonX Team</div>
      </div>
    </div>
  );
}
