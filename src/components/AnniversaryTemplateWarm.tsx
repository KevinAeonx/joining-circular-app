...
export default function AnniversaryTemplateWarm({ formData, message, id }: Props) {
  ...
  return (
    <div id={id} style={{
      ...
      <div style={{ position:"absolute", top:"18px", left:0, right:0, display:"flex", justifyContent:"center", zIndex:4 }}>
        <div style={{
          backgroundColor:"rgba(0,0,0,0.30)", borderRadius:"14px", padding:"6px 22px",
          border:"1px solid rgba(255,200,60,0.35)",
          filter:"drop-shadow(0 0 5px rgba(255,180,40,0.45))",
        }}>
      ...
      <div style={{
        ...
        {message || <span style={{ color:"rgba(255,220,160,0.50)", fontStyle:"italic" }}>Fill in details and generate a message...</span>}
      </div>
      ...
      <div style={{ position:"absolute", bottom:"24px", left:0, right:0, textAlign:"center", zIndex:4 }}>
        ...
        <div style={{ color:"rgba(255,220,160,0.95)", fontSize:"16px", fontWeight:"bold", marginTop:"3px" }}>The AeonX Team</div>
      </div>
    </div>
  );
}
