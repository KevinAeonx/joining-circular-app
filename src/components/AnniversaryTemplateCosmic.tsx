...
export default function AnniversaryTemplateCosmic({ formData, message, id }: Props) {
  ...
  return (
    <div id={id} style={{
      ...
      background: "linear-gradient(150deg, #1A0033 0%, #4A148C 50%, #6A1B9A 80%, #7B1FA2 100%)",
      ...
      <svg style={{ position:"absolute", inset:0, width:"600px", height:"780px", pointerEvents:"none", zIndex:2 }}
        ...
        {/* Cosmic glow circles */}
        <circle cx={300} cy={780} r={240} fill="rgba(180,100,255,0.08)" />
        <circle cx={60} cy={100} r={80} fill="rgba(255,255,255,0.03)" />
        <circle cx={540} cy={90} r={65} fill="rgba(255,255,255,0.03)" />
      ...
      <div style={{ position:"absolute", top:"18px", left:0, right:0, display:"flex", justifyContent:"center", zIndex:4 }}>
        <div style={{ backgroundColor:"rgba(20,0,50,0.60)", borderRadius:"14px", padding:"6px 22px", border:"1px solid rgba(212,175,55,0.40)" }}>
      ...
      <div style={{
        ...
        color:"#FFD700", fontSize:"26px", fontWeight:800,
      ...
      {formData.role && (
        <div style={{
          ...
          textAlign:"center", zIndex:4,
          color:"rgba(225,200,255,0.90)", fontSize:"13px", fontWeight:600,
          letterSpacing:"1.5px", textTransform:"uppercase",
        }}>
          {formData.role}
        </div>
      ...
      <div style={{
        ...
        color:"#FFD700",
        textShadow:"0 2px 16px rgba(0,0,0,0.30), 0 0 35px rgba(255,200,0,0.25)",
      }}>
        {yearsLabel}
      </div>
      ...
      <div style={{
        ...
        textAlign:"center", zIndex:4,
        color:"rgba(220,200,255,1)", fontSize:"15px", lineHeight:"1.75", fontWeight:500, fontStyle:"italic",
      }}>
        {message || <span style={{ color:"rgba(180,150,220,0.50)", fontStyle:"italic" }}>Fill in details and generate a message...</span>}
      </div>

      {/* ── Footer ── */}
      <div style={{ position:"absolute", bottom:"24px", left:0, right:0, textAlign:"center", zIndex:4 }}>
        <div style={{ color:"rgba(200,170,255,0.70)", fontSize:"14px" }}>Best Regards,</div>
        <div style={{ color:"rgba(220,190,255,0.95)", fontSize:"16px", fontWeight:"bold", marginTop:"3px" }}>The AeonX Team</div>
      </div>
    </div>
  );
}
