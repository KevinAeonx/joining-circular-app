...
export default function AnniversaryTemplateRoyal({ formData, message, id }: Props) {
  ...
  return (
    <div id={id} style={{
      ...
      <div style={{
        ...
        {message || <span style={{ color:"rgba(180,210,255,0.55)", fontStyle:"italic" }}>Fill in details and generate a message...</span>}
      </div>
      ...
      <div style={{ position:"absolute", bottom:"24px", left:0, right:0, textAlign:"center", zIndex:4 }}>
        ...
        <div style={{ color:"rgba(187,222,251,0.95)", fontSize:"16px", fontWeight:"bold", marginTop:"3px" }}>The AeonX Team</div>
      </div>
    </div>
  );
}
